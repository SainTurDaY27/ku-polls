"""This tests.py contain test case for testing ku-polls."""
import datetime
...
class QuestionModelTests(TestCase):
    """QuestionModelTests contain test for methods in models.py."""

    def test_was_published_recently_with_future_question(self):
        """
        Method was_published_recently() returns False for questions.
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_past_question_after_end_date(self):
        ...
        It will redirect to index page for returning error message.
        """
        past_question = create_question(
        ...
        self.assertRedirects(response,
                             reverse('polls:index'), status_code=302,
